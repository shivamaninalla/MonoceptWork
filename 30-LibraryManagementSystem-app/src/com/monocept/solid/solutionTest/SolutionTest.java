...
public class SolutionTest {
	public static void main(String[] args) {
		...
		while (x) {
			...
			switch (c) {
			case 1:
				userRegistration(scanner, random, user, iRegister);
				break;
			case 2:
				addBook(scanner, book, catalogBook1);
				break;
			case 3:
				bookBorrow(scanner, user, book, iRegister, catalogBook1, borrowBookUser);
				break;
			case 4:
				bookReturn(scanner, user, book, iRegister, catalogBook1, returnBook);
				break;
			case 5:
				listofBooks(catalogBook1);
				break;
			case 6:
				listofUsers(iRegister);
				break;
			case 7:
	...
	private static boolean bookReturn(Scanner scanner, UserSolution user, BookSolution book, IRegister registerUser,
			ICatalogBook catalogBook, ReturnBook returnBook) {
	...
	private static boolean bookBorrow(Scanner scanner, UserSolution user, BookSolution book, IRegister registerUser,
		ICatalogBook catalogBook, BorrowBookUser borrowBookUser) {
		System.out.println("Enter user name: ");
		String name = scanner.next();
	...
	private static void listofBooks(ICatalogBook catalogBook) {
